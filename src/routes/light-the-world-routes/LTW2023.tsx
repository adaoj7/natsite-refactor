    ...
    <LTW title="2024">
      <div>
        ...
        <p>
          ...
          weekly. Over 30,000 different volunteers have given their time to the
        ...
        <p>
          It has evolved into a community needs ministry. In addition to feeding
          physical hunger, a weekly worship service and medical clinic are
          offered. Other community services provided include weekly adult
        ...
        <p>
          ...
          Heart of Illinois Harvest volunteers from grocery stores, restaurants,
          and schools. Loaves and Fish also accepts donations of non-perishable
          food items and toiletries for our guests to take home. Volunteers work
          during the week, taking in, warehousing, and organizing donations
        </p>
        <h2 className="card-title justify-center">
          Porch Pantry -- Kelli Martin
        </h2>
        <p>
          Porch Pantry was started in March 2020, by Kelli and Charles Martin on
          their front porch. According to Charles, “We thought it would last a
          few months and be over. What we found in serving the Peoria area was
          friendship, chosen family, community, and love for our neighbors.”
        </p>
        <p>
        ...
        <p>
          ...
          become the Martins extended family. This act of love is funded by the
          goodness of the Martins and donations from both individuals and
